...
This project is a brand-agnostic, 3-servo motion-controlled automation system for sorting, collecting, and cartoning products. Built end-to-end by the author, it includes PLC programming, motion logic, and hardware-to-HMI integration.<br>
